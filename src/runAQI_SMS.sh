...
pipline=$(basename $0)
Usage="\nUsage:\n\t#Genome assessing using AQI:\n\t$pipline -g  Genome.fa -z  Genome.fa.size -e LRout/LR_eff.size  -C LRout/LR_putative.SE.SH  -D LRout/LR_sort.depth  [default:  -R 0.65 -P 0.4 -Q 0.6 -M 10000 -w 1000000 -n 10 -j 1 -b F -m 1000000]"
...
while getopts "g:z:e:C:D:n:s:w:m:M:j:b:R:P:Q:y:x:o" opt
do
    case $opt in
        g)      ref_fa=$OPTARG ;;
...
rm -rf  ER.tmp_N.stat HR.tmp_N.stat  runAQI_out/*Report.tmp  runAQI_out/Gap_out/ runAQI_out/tmp_seq* runAQI_out/locER_out/out_final.S*R.out runAQI_out/strER_out/out_final.L*R.out runAQI_out/strER_out/*tmp runAQI_out/locER_out/*tmp runAQI_out/locER_out runAQI_out/strER_out/*_putative* runAQI_out/*_gapN.tmp
